...
\begin{itemize}
	...
	\item Est-ce que la promotion d'inviter d'autres clients et hôtes en échange pour des réductions apporte de nouveaux usageurs actifs à la plateforme?
\end{itemize}
...
\subsection{Les data-marts}

\subsubsection{Une table des faits}

\subsubsection{Un modèle de transactions}
